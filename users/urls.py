...
from .views import RegisterView, LoginView, UserView, LogoutView,ProfileRetrieveAPIView,NotesViewSet,NotesDelete,NotesUpdate
...
urlpatterns = [
    ...
    re_path(r'^notes/(?P<user_id>\w+)/', NotesViewSet),
